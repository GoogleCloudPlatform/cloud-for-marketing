...
/**
 * Feature accumulator to extract the sum of values of a fact. Example: Extract the sum of all the
 * values of the fact 'page_views' as a feature.
 */
public class SumValueFeatureAccumulator extends FeatureAccumulator {

  private double sum;

  public SumValueFeatureAccumulator(
  ...
  public Map<String, Object> getFeatures() {
    ...
    return ImmutableMap.of(columnName, sum);
  }
}
