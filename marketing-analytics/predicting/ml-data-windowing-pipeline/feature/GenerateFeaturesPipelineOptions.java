...
public interface GenerateFeaturesPipelineOptions extends PipelineOptions {
  ...
  @Description("Location prefix to read the windowed avro objects.")
  @Validation.Required
  String getWindowedAvroLocationPrefix();
  void setWindowedAvroLocationPrefix(String windowedAvroLocationPrefix);
  ...
  @Validation.Required
  String getFeatureDestinationTable();
  void setFeatureDestinationTable(String featureDestinationTable);
}
